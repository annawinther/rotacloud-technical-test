    ...
    return (
         <section id="home">
            ...
            <p>
                ...
                <a href="https://custom.rotacloud.com/angular-challenge/users.json" target="_blank" rel="noopener noreferrer">https://custom.rotacloud.com/angular-challenge/users.json</a>
            </p>

            <p>
                The JSON data for the roles is located at:<br />
                <a href="https://custom.rotacloud.com/angular-challenge/roles.json" target="_blank" rel="noopener noreferrer">https://custom.rotacloud.com/angular-challenge/roles.json</a>
            </p>
         </section>
    )
}
